...
#[repr(i8)]
pub enum Error { IndexOutOfBound = 1, ItemMissing, LengthNotEnough, Encoding, InvalidFd, WaitFailure, OtherEndClosed, MaxVmsSpawned, MaxFdsCreated, InvalidArgs = 10, HashMismatch = 11, MemoTooLarge = 12, MissingWitness = 13 }
