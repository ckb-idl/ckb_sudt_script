...
#[repr(i8)]
pub enum Error { IndexOutOfBound = 1, ItemMissing, LengthNotEnough, Encoding, InvalidFd, WaitFailure, OtherEndClosed, MaxVmsSpawned, MaxFdsCreated, InvalidArgs = 10, InvalidAuthorization = 11, MissingWitness = 12 }
